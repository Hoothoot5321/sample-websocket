...
import { Message, TYPE } from "./class.js";
export function onMessage(ws, ev) {
    let msg = ev.data;
    console.log(msg);
    console.log("");
        ...
        switch (temp.type) {
            ...
            case TYPE.CREATE:
                ...
                for (let client of clients) {
                    client.connection.send(JSON.stringify(new Message(TYPE.CREATE, JSON.stringify(channel_name))));
                }
                break;
        }
    }
